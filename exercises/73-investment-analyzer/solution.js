...
function calculateROI(initialValue, finalValue) {
  // CORREGIDO: el denominador es initialValue, no finalValue
...
function calculateFutureValue(presentValue, annualRate, years) {
  // CORREGIDO: usar Math.pow para el interés compuesto, no multiplicación lineal
...
function calculateCAGR(startValue, endValue, years) {
  // CORREGIDO: exponente es (1 / years), no years
...
function calculateRuleOf72(annualRatePercent) {
  // CORREGIDO: 72 dividido entre la tasa, no la tasa dividida entre 72
...
function calculateBreakEven(fixedCosts, pricePerUnit, variableCostPerUnit) {
  ...
  // CORREGIDO: dividir entre el margen de contribución, no solo entre el precio
...
function calculateVolatility(returns) {
  ...
  // CORREGIDO: dividir entre (n − 1) para desviación estándar muestral
...
function rankByROI(investments) {
  // CORREGIDO: orden descendente (b − a), no ascendente (a − b)
