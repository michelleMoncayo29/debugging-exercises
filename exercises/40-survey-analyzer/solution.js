...
// CORREGIDO: el índice debe ser Math.floor(p / 100 * (n - 1))
// para quedarse dentro del arreglo; usar n en lugar de n-1 causaba
// acceso fuera de límites en el percentil 100, y valores incorrectos
...
if (require.main === module) {
  ...
  const segmented = [
    { answer: 4, segment: 'Premium' },
    { answer: 5, segment: 'Premium' },
    { answer: 2, segment: 'Básico' },
    { answer: 3, segment: 'Básico' },
  ];
  console.log('Tabla cruzada:', crossTabulate(segmented));
}
