...
class Inventory {
  ...
  // CORREGIDO: punto de reorden = avgDailyDemand * leadTimeDays + safetyStock
  // El bug usaba avgDailyDemand * safetyStock + leadTimeDays (operandos intercambiados),
  // produciendo valores incorrectos al mezclar la demanda con el stock de seguridad.
...
if (require.main === module) {
  ...
  console.log('Reorder point:', inv.calculateReorderPoint('A001')); // 70
  console.log('EOQ:', inv.calculateEOQ('A001'));                     // 427
  console.log('Days of supply:', inv.getDaysOfSupply('A001'));       // 10
  console.log('Needs reorder:', inv.needsReorder('A001'));           // false
  console.log('Summary:', inv.getSummaryReport());
}
