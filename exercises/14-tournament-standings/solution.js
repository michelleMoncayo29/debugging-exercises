...
function calculatePoints(wins, draws) {
  // CORREGIDO: Victoria vale 3 puntos (no 2), empate vale 1 punto
...
function recordMatch(homeTeam, awayTeam, homeScore, awayScore) {
  homeTeam.played++;
  awayTeam.played++;
  // CORREGIDO: Cada equipo suma sus propios goles a favor y los del rival en contra
...
function getStandings(teams) {
  // CORREGIDO: Ordenar de mayor a menor (b - a), no de menor a mayor (a - b)
